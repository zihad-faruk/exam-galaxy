...
<div class="row" style="margin-top:30px">
    ...
    <div class="col-lg-2"><a href="teacher_login.php"><button class="btn btn-large btn-success"><i class="fa fa-user"></i> Log In</button></a></div>
    <div class="col-lg-1"></div>
</div>
...
<div class="reg_intro container">
    <div class="row">
        ...
        <h2><span style="color:#66BC6D;animation-delay: 400ms" class="animated bounceInDown">Teacher</span> Registration</h2>
    </div>
</div>
...
<div id="registration_div">
    <form action="" method="POST" name="fr" id="fr" style="margin-bottom:30px">
        ...
        <input type="number" name="user_name" id="user_name" required placeholder="Your Social Security Number"><br><br>
        ...
        <input type="text" name="dept" required placeholder="The department you are working in">
        <input type="number" name="class" required min="1" placeholder="Your Contact Number"><br><br>
            ...
            if ($pass == $pass_again) {
                ...
                if (strlen($name) > 32 || strlen($surname > 32)) {
                    ...
                    if (strlen($pass) < 6) {
                        ...
                        $query = "INSERT INTO `teachers_approve` VALUES ('$student_id','$name','$surname','$dept','$email','$pass_hash','$class')";
