...
?>
    ...
    <div style="height: 94vh">
        ...
        <h1 style="font-size: 60px;"><span style="color: #66BC6D">SET</span> MCQ Exam Page</h1>
...
if (isset($_POST['subject']) && isset($_POST['class']) && isset($_POST['duration']) && isset($_POST['full_marks']) && isset($_POST['num_of_ques'])) {
    ...
    if (!empty($subject) && !empty($class) && !empty($duration) && !empty($full_marks)) {
        ...
        $query = "INSERT INTO `exams`(exam_type,set_by,subject,class,time,full_marks,num_of_ques) VALUES ('MCQ','$teacher_name','$subject','$class','$duration','$full_marks','$num_of_ques')";
...
?>
    ...
    <form action="mcq_exam.php" method="POST">
        <input type="text" placeholder="Subject" name="subject"><br><br>
        <input type="number" placeholder="Class" name="class" min="1"><br><br>
        <input type="number" placeholder="Exam Duration in Hours" name="duration"  min=".3" max="1"><br><br>
